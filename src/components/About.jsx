...
export default function About() {
  return (
    <div
      className="px-5 lg:px-28 py-12 bg-white text-black flex justify-between flex-col lg:flex-row items-center gap-10"
      id="about"
    >
      {/* IMAGE */}
      <motion.div
      ...
      >
        ...
        <p className="text-gray-500 text-sm/6 lg:text-base mt-5 lg:mt-6 leading-relaxed">
          I'm a Electrical Enginnering student at{" "}
          <span className="text-red-600 font-semibold">MMMUT</span>, passionate
          about building modern web applications and solving real-world problems
          through code.
        </p>
        ...
        <p className="text-gray-500 text-sm/6 lg:text-base mt-4 leading-relaxed">
          ...
          using technologies like React, Node.js, and MongoDB. I enjoy creating
          clean, efficient, and scalable applications with strong UI/UX design.
        </p>

        <p className="text-gray-500 text-sm/6 lg:text-base mt-4 leading-relaxed">
          So far, I’ve worked on multiple projects including web apps,
          and systems, constantly improving my skills and exploring new
