      ...
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
            ...
            Designing. I build modern, high-performance applications and
            continuously improve my skills to create impactful digital
            experiences.
          </motion.p>
          ...
          >
            {[
              { Icon: BiLogoGmail, url: "mailto:your-sp2100900@gmail.com" },
              {
                Icon: IoLogoLinkedin,
                url: "https://www.linkedin.com/in/sumit-pandey-b9875733a/",
              },

              { Icon: BsGithub, url: "https://github.com/sumitpandey4/" },
            ].map(({ Icon, url }, index) => (
              <motion.a
                key={index}
                href={url}
        ...
        >
          <img
            className="h-[350px] lg:h-[450px] w-auto mx-auto rounded-xl"
